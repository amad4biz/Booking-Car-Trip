			...
			<div class="box">
				...
				<div class="boxBody">
					<div class="col-sm-6 padding-left padding-right marginTop20">
                        ...
                        <input type=hidden name="pickupaddress" value="<?php echo $_POST['pickUp_address']?>">
						<?php if($_POST['trip'] == 2) {?>
                        <input type=hidden name="pickupaddress2" value="<?php echo $_POST['pickUp_address2']?>">
                        <?php } ?>
					...
					<div class="col-sm-6 padding-left padding-right marginTop20">
                        ...
                        <input type=hidden name="dropoffaddress" value="<?php echo $_POST['dropOff_address']?>">
						<?php if($_POST['trip'] == 2) {?>
                        <input type=hidden name="dropoffaddress2" value="<?php echo $_POST['dropOff_address2']?>">
                        <?php } ?>
                        <div class="form-group">
							<?php
				...
				<div class="boxBody">
					<div class="row padding-left padding-right">
						<div style="margin:10px 0;" class="col-sm-12 bottomBarDetail borderd padding-left padding-right">
							<div class="col-sm-3">
								<strong>Number Of Passengers : </strong> <input type=hidden name="numberofpassengers" value="<?php echo $_POST['passengers'] ?>"><?php echo $_POST['passengers'] ?>
							</div>
                            <input type=hidden value="<? echo $_POST['trip']; ?>" id="trip" name="trip">
							<div class="col-sm-3">
								<strong>Trip Type : </strong> <?php if($_POST['trip'] == 1){echo 'One Way';}else{echo 'Round Trip';} ?>
							</div>
							<div class="col-sm-3">
								<strong>Vehicle Selected : </strong> <input type=hidden name="vehicleName" value="<?php echo $vehicleName; ?>"><?php echo $vehicleName; ?>
							</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="airline_<?php echo $airport['code'] . '_' . $airport['tripleg'] ?>" >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										<label for="flight">Flight #: <span class="req">*</span></label>
										<input type="text" class="form-control" name="flightNumber_<?php echo $airport['code'] . '_' . $airport['tripleg'] ?>" >
									</div>
								</div>
								<div class="col-sm-5">
									<div class="form-group">
										...
										<input type="text" class="form-control pickupTime" id="flightTime_<?php echo $airport['code'] . '_' . $airport['tripleg'] ?>" name="flightTime_<?php echo $airport['code'] . '_' . $airport['tripleg'] ?>" >
									</div>
								</div>
							</div>						
						</div>	
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<select class="form-control" name="noOfLuggage_<?php echo $airport['code'] . '_' . $airport['tripleg'] ?>" >
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<select class="form-control" name="noOfCarryOnItems_<?php echo $airport['code'] . '_' . $airport['tripleg'] ?>" >
											<option value="">Select Number</option>
					...
					<div class="row">
						<div style="margin-top:20px;" class="col-sm-6 padding-left padding-right">
						    ...
						    <div class="form-group">
								...
								<input type="text" data-mask="1-000-000-0000" class="form-control" id="cellPhone" name="cellPhone">
						    </div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="text" class="form-control pickupDate" id="pickupDate" name="pickupDate">
								    </div>
								</div>
								...
								<div class="col-sm-6">
									<div class="form-group bootstrap-timepicker">
										...
										<input type="text" placeholder="Time" class="form-control pickupTime" id="pickupTime" name="pickupTime">
								    </div>
								</div>
                                <?php } else { ?>    
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="text" class="form-control pickupDate"  name="pickupDate_return">
									    </div>
									</div>
									...
									<div class="col-sm-6">
										<div class="form-group bootstrap-timepicker">
											...
											<input type="text" placeholder="Time" class="form-control pickupTime" id="pickupTime_return" name="pickupTime_return">
									    </div>
									</div>
                                    <?php } else { ?>  
                                    <div class="col-sm-6 hidden">
                                        <div class="form-group bootstrap-timepicker">
                                            ...
                                            <input type="text" placeholder="Time" class="form-control pickupTime" value="234" id="pickupTime_return" name="pickupTime_return">
                                        </div>
                                    </div>
                                    <?php } ?>
								</div>
				...
				<div class="boxBody">
					<div style="margin-top:20px;" class="col-sm-6">
						...
						<div style="margin-top:-15px;" class="form-group">
                            			...
                            			<select class="form-control" id="tipPercentage" name="tipPercentage" onChange="updateCostOnTip(this.value)" onblur="updateCostOnTip(this.value)">
					...
					<div style="margin-top:20px;" class="col-sm-6">
					    ...
					    <div class="form-group">
							...
							<input type="text" class="form-control" id="billingCard" name="billingCard">
					    </div>
					    <div class="form-group">
						    <div class="row">
								<div class="col-sm-4">
...
<div id="CashModal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
          Your credit card will not be charged, It’s needed only to secure the reservation.
      </div>
    </div>
  </div>
</div>
...
$footerJs = $footerJs1 . <<<EOD
    ...
    function addtocalendar(){
        ...
        var numberofpassengers = jQuery('#numberofpassengers').val();
        var vehicleName = jQuery('#vehicleName').val();
        var pickupaddress = jQuery('#pickupaddress').val();
        var dropoffaddress = jQuery('#dropoffaddress').val();

        jQuery.ajax({
            dataType: 'json',                    
            type: 'post',
            data: {name: name, numberofpassengers:numberofpassengers, pickupaddress:pickupaddress, dropoffaddress:dropoffaddress, vehicleName:vehicleName, pickupDate:pickupDate, pickupTime:pickupTime},                    
